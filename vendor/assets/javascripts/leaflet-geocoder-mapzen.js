...
;(function (factory) { // eslint-disable-line no-extra-semi
  ...
  L.Control.Geocoder = L.Control.extend({
    ...
    onAdd: function (map) {
      var base = L.DomUtil.get('find-loc');
      var container = L.DomUtil.create('div',
          'leaflet-pelias-control leaflet-control', base);
      // var container = $("#find-loc");
      this._body = document.body || document.getElementsByTagName('body')[0];
      this._container = container;
      this._input = L.DomUtil.create('input', 'leaflet-pelias-input search_loc', this._container);
      ...
      // $('<div class="empty"></div>');
       var empty = L.DomUtil.create('div', 'leaflet-control');
       return empty;
      // return container;
    },
